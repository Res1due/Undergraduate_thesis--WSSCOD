...
class PolypObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize, istraining=True):
        ...
        self.dataset_root = os.path.dirname(os.path.normpath(image_root))
    ...
    def _load_quality_scores(self):
        score_path = os.path.join(self.dataset_root, 'quality_scores.csv')
        if not os.path.exists(score_path):
            return {}

        scores = {}
        with open(score_path, 'r', encoding='utf-8-sig', newline='') as f:
