...
def train(opt):
    ...
    print(f'[TrainConfig] ration={opt.ration}')
    print(f'[TrainConfig] train_root={opt.train_root}')
    print(f'[TrainConfig] train_dataset_len={len(train_dataset)}')
    train_loader = torch.utils.data.DataLoader(dataset=train_dataset, batch_size=opt.batchsize, num_workers=4, shuffle=True)
...
def main():
    ...
    print('[TrainConfig] ===== Run Configuration =====')
    print(f'[TrainConfig] ration={opt.ration}')
    print(f'[TrainConfig] train_root={opt.train_root}')
    print(f'[TrainConfig] val_root={opt.val_root}')
    print(f'[TrainConfig] save_path={opt.save_path}')
    print(f'[TrainConfig] batchsize={opt.batchsize}, trainsize={opt.trainsize}, epoch={opt.epoch}')
    print('[TrainConfig] =============================')
